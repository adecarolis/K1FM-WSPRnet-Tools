...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='This utility takes data from WSPR archives and generates KML files for K1FM Picoballoon flights.')
    parser.add_argument('callsign', metavar='callsign', type=str, help='balloon callsign')
    ...
    parser.add_argument('--start-month', type=year_month_type, dest='start_month', help='year-month when the flight begun (eg. 2019-09). Defaults to current month')
    parser.add_argument('--end-month', type=year_month_type, dest='end_month', help='year-month when the flight ended (eg. 2019-11). Defaults to current month')
    parser.add_argument('--skip-downloads', dest='skip_downloads', action='store_true')
    ...
    for n in files:
        ...
        res = WSPRnet_to_kml.extract_data(csv_path, args.callsign, args.first_identifier, args.second_identifier)
